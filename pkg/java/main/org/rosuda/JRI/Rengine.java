...
public class Rengine extends Thread {
	...
	static {
		try {
			...
			if (iu == null || !iu.equals("yes")) {
				...
				e.printStackTrace();
				//System.exit(1);  //W.Maddison don't want any chance of this happening!
			}
		}
	}
	...
	public static boolean versionCheck() {
		long thisVers = getVersion();
		long rniVers = rniGetVersion();
		if (thisVers != rniVers){
			mesquite.lib.Debugg.println("Mesquite's JRI version " + thisVers + "; system's JRI version " + rniVers);
			return false;
		}
		return true;
	}
